...
> **Project status:** Completed dashboard, final validation and portfolio publication in progress.
...
|-- README.md
|-- Himalayan_Expeditions_Analytics.pbix
|-- images/
|   |-- 01-expedition-trends.png
|   |-- 02-peak-popularity-success.png
|   |-- 03-risk-safety.png
|   `-- 04-global-participation.png
`-- documentation/
